...
$sql = "INSERT INTO scholarship.studenttest (stdid,name,title,college,year,amount) VALUES ('$stdid','$name','$title','$university','$year','$amount')";
...
<tr> 
    <td align="right"><font color="#191970" size="5" face="segeo print">COLLEGE</font></td>  
         <td>
    <input type="text" placeholder="Enter university name" name="college"  style="HEIGHT:30PX;WIDTH:500PX;"/>
         </td>  
 </tr>
<tr> 
